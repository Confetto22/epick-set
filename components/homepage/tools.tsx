...
const Tools = () => {
  const cards = [
    ...
    {
      icon: <CloudDownload size={32} className="text-blue" />,
    ...
    {
      icon: <Music size={32} className="text-blue" />,
    ...
    {
      icon: <Smartphone size={32} className="text-blue" />,
  ...
  return (
    <section className="dark:bg-secondary px-6 py-16 flex items-center justify-center">
      <div className="max-w-6xl flex flex-col gap-10 w-full">
        <div className="flex flex-col items-start gap-5 text-foreground">
          ...
          <p className="text-lg text-muted-foreground leading-[1.45] max-w-[862px]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-8 justify-items-center">
          {cards.map((card) => (
            <div
              key={card.title}
              className="border border-purple justify-self-center rounded-[16px] max-w-sm h-full min-h-80 mx-auto"
            >
              <div className="bg-card p-6 h-full rounded-[16px] flex flex-col gap-[10px]">
                <div className="flex flex-col gap-[10px] items-start justify-center">
                  <div className="px-4 py-[10px] flex flex-col gap-[10px] w-full">
                    <div className="relative w-[60px] h-[60px] bg-blue/20 rounded-full">
                      <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-8 h-8 flex items-center justify-center">
                        {card.icon}
                      </div>
                    </div>
                    <div className="flex flex-col gap-1">
                      <h3 className="font-bold text-[20px] leading-normal text-card-foreground">
                        {card.title}
                      </h3>
                    </div>
                  </div>
